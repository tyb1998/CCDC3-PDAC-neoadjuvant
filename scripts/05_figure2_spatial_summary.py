#!/usr/bin/env python3
"""Generate Figure 2 spatial compartment and specificity summaries."""
import argparse
...
def main():
    ...
    comp_summary.to_csv(args.output / 'figure2_compartment_summary.csv', index=False)
    ...
    full[columns].to_csv(args.output / 'figure2_spatial_specificity_summary.csv',
                         index=False)
